...
Я - начинающий QA тестировщик. Предпочитаю тестировать сайты и бэкенды. 
Есть опыт работы со всеми перечисленными приложениями и сервисами из стека технологий.
Люблю удаленку и part-time)
...
[<img src="https://github.com/moxuq/moxuq/blob/main/certificate_ru.png" width="280px" hspace="10px" alt="Сертификат"](https://github.com/moxuq/moxuq/blob/main/certificate_ru.png)
